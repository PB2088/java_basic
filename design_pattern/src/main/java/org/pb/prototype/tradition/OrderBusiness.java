    ...
    public void createOrder(OrderApi order) {
        ...
        while (order.getOrderProductNum() > MAX_ORDER_PRODUCT_NUM) {
            ...
            if (order instanceof PersonalOrder) {
                ...
                newPersonalOrder.setCustomerName(p.getCustomerName());
                newPersonalOrder.setProductId(p.getProductId());
                newPersonalOrder.setOrderProductNum(MAX_ORDER_PRODUCT_NUM);
                ...
                newEnterpriseOrder.setOrderProductNum(MAX_ORDER_PRODUCT_NUM);
