...
public class SecurityMgr {
    ...
    public void login(String user) {
        ...
        List<Flyweight> authorizationFlyweights = selectByUser(user);
        map.put(user, authorizationFlyweights);
    }

    private List<Flyweight> selectByUser(String user) {
        List<Flyweight> authorizationFlyweights = new ArrayList<>();
        ...
        TestDB.colDB.stream().forEach(s -> {
            ...
            if (Objects.equals(ss[0], user)) {
                ...
                authorizationFlyweights.add(flyweight);
            }
        });
    ...
    public boolean hasPermit(String user, String securityEntity, String permit) {
        List<Flyweight> authorizationFlyweights = map.get(user);
        ...
        for (Flyweight flyweight : authorizationFlyweights) {
            System.out.println("AuthorizationFlyweight==" + flyweight);
